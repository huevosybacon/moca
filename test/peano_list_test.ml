...
testing ("Peano_list (automatic) - seed: 494401614")
;;

testi
  (0)
  (let x0 = succ (succ zero) in
   let x1 = plus [ (succ zero); (plus [ zero; zero; zero ]); (succ zero) ] in
...
testi
  ...
  (let x0 = succ (succ zero) in
   ...
   let x2 = plus [ (succ zero); (plus [ zero; zero; zero ]); (succ zero) ] in
   plus [ (plus [ x0; x1 ]); x2 ] = plus [ x0; x1; x2 ])
;;
   ...
   let x2 =
     plus
       [ (plus [ zero; zero; zero ]); (plus [ zero; zero; zero ]);
         (plus [ zero; zero; zero ]) ] in
   let x3 = plus [ (succ zero); (succ zero); (succ zero) ] in
   let x4 = plus [ (succ zero); (succ zero); (succ zero) ] in
   plus [ x0; (plus [ x1; x2 ]); (plus [ x3; x4 ]) ] =
   plus [ x0; x1; x2; x3; x4 ])
;;
...
testi
  ...
  (let x0 = succ (plus [ zero; zero; zero ]) in
   ...
   let x4 = plus [ (plus [ zero; zero; zero ]); (succ zero); (succ zero) ] in
   plus [ x0; (plus [ x1; x2 ]); (plus [ x3; x4 ]) ] =
   plus [ x0; x1; x2; x3; x4 ])
;;
...
testi (21) (let x0 = zero in plus [ zero; x0 ] = x0)
;;
...
testi
  (23)
  (let x0 = plus [ zero; (succ zero); (succ zero) ] in plus [ zero; x0 ] = x0)
;;

testi
  (24)
  (let x0 = plus [ zero; (plus [ zero; zero; zero ]); zero ] in
   plus [ zero; x0 ] = x0)
;;
...
testi
  (27)
  (let x0 = succ (plus [ zero; zero; zero ]) in plus [ x0; zero; zero ] = x0)
;;
...
testi (29) (let x0 = succ (succ zero) in plus [ x0; zero; zero ] = x0)
;;
  ...
  (let x1 = zero in
   let x2 =
     [ plus
       ...
       plus [ (succ zero); (succ zero); (succ zero) ] ] in
...
testi
  (31)
  (let x1 = plus [ (succ zero); (succ zero); (succ zero) ] in
   let x2 = [ succ (succ zero); succ (succ zero); succ (succ zero) ] in
   plus (succ x1 :: x2) = succ (plus (x1 :: x2)))
;;
...
testi
  (33)
  (let x1 = plus [ zero; (succ zero); (plus [ zero; zero; zero ]) ] in
   let x2 =
     [ plus
         [ (succ zero); (plus [ zero; zero; zero ]);
           (plus [ zero; zero; zero ]) ]; succ (plus [ zero; zero; zero ]);
...
testi
  ...
  (let x1 =
   ...
   let x2 =
     [ plus
         [ (succ zero); (plus [ zero; zero; zero ]);
           (plus [ zero; zero; zero ]) ]; succ (succ zero); zero ] in
   plus (succ x1 :: x2) = succ (plus (x1 :: x2)))
;;
